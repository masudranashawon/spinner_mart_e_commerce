    ...
    <div class="card-body">
        <form action="{{ route('admin.pages.store') }}" method="POST">
            ...
            <fieldset class="p-lg-4 mb-3 rounded-lg border p-3">
                ...
                <div class="mb-4">
                    <x-input name="title" label="Page Title" placeholder="e.g. Privacy Policy" />
                </div>

                <div class="mb-4">
                    <x-textarea name="content" label="Page Content" placeholder="Write page content..." class="tinymce-editor" />
                </div>

                <!-- Show in Footer Checkbox -->
                <div class="custom-control custom-switch mb-3">
                    <input type="checkbox" class="custom-control-input" id="show_in_footer" name="show_in_footer" value="1" checked>

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="editBtn btn btn-primary btn-icon btn-md" data-name="{{ $tag?->name }}" data-id="{{ $tag?->id }}" data-toggle="modal" data-target="#tagEditModal"><i data-feather="edit"></i></button>

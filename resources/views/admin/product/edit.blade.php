...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ url()->previous() }}" class="d-flex justify-content-center align-items-center bg-primary rounded px-2 py-1 text-white">
            ...
            <fieldset class="p-lg-4 mt-3 rounded-lg border p-3">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex flex-column">
                        <x-input name="product_sku" id="product_sku" label="Product SKU" placeholder="Product SKU" :value="$product?->sku_code" readonly />
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-select name="category" id="category" label="Select Category">
                            ...
                            <option value="{{ $category?->id }}" {{ $product->details->category_id == $category?->id ? 'selected' : '' }}>{{ $category->name }}
                            </option>
                            @endforeach
                        </x-select>
                    </div>
                    ...
                    <div class="col-md-6">
                        <x-select name="sub_category" label="Select Sub Category">
                            ...
                            <option value="{{ $subCategory?->id }}" {{ $product->details->sub_category_id == $subCategory?->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-input name="discount_price" label="Discount Price" placeholder="Discount Price" :value="$product?->discount_price" />
                    </div>
                </div>
            </fieldset>
                    ...
                    <div class="col-lg-9 mt-lg-0 mt-3">
                        ...
                        <div id="galleryPreview" class="d-flex mt-lg-4 flex-wrap gap-2">
                            ...
                            <div class="gallery-item position-relative" data-existing="1" data-id="{{ $gallery->id }}">
                                <img src="{{ Storage::url($gallery->src) }}" alt="{{ $gallery->media_id }}" class="w-100 h-100 rounded border" style="object-fit: cover;">

...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('product.index') }}" class="d-flex justify-content-center align-items-center bg-primary rounded px-2 py-1 text-white">
    ...
    <div class="card-footer">
        <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="p-lg-4 mt-3 rounded-lg border p-3">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex flex-column">
                        <button type="button" id="generateSku" class="btn btn-sm btn-primary align-self-end px-2 py-1" style="margin-bottom:-1.5rem; cursor:pointer; z-index:2;">Generate
                            SKU</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-input name="discount_price" label="Discount Price" placeholder="Discount Price" />
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="p-lg-4 mt-3 rounded-lg border p-3">
                ...
                <x-textarea name="description" label="Description" placeholder="Write product description..." class="tinymce-editor" />
            ...
            <fieldset class="p-lg-4 mt-3 rounded-lg border p-3">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <label for="thumbnail">
                            <img src="{{ asset('/upload-picture.png') }}" class="thumbnail-preview" id="thumbnail-preview" alt="thumbnail" />
                        </label>

      ...
      <div class="row align-items-center">
        <div class="col-lg-2">
          <div class="navbar-header">
            <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('frontend/assets/images/logo.svg') }}"
                alt="logo"></a>
          </div>
        </div>
                    ...
                    <div class="mini-cart-items">
                      <div class="mini-cart-item clearfix">
                        <div class="mini-cart-item-image">
                          <a href="product.html"><img src="{{ asset('frontend/assets/images/cart/img-1.jpg') }}"
                              alt></a>
                        </div>
                      ...
                      <div class="mini-cart-item clearfix">
                        <div class="mini-cart-item-image">
                          <a href="product.html"><img src="{{ asset('frontend/assets/images/cart/img-2.jpg') }}"
                              alt></a>
                        </div>
                        <div class="mini-cart-item-des">
                      ...
                      <div class="mini-cart-item clearfix">
                        <div class="mini-cart-item-image">
                          <a href="product.html"><img src="{{ asset('frontend/assets/images/cart/img-3.jpg') }}"
                              alt></a>
                        </div>
                        <div class="mini-cart-item-des">
